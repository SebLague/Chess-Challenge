...
namespace ChessEngine
{
	public readonly struct Move : IEquatable<Move>
	{
		...
		public bool IsEnPassant => move.MoveFlag == Internal.Board.Move.EnPassantCaptureFlag;

		public bool IsPromotion => move.IsPromotion;
		public bool IsCastles => move.MoveFlag == Internal.Board.Move.CastleFlag;
		public bool IsNull => move.IsNull;
		public ushort RawValue => move.Value;
		public static readonly Move NullMove = new();

		readonly Internal.Board.Move move;
		...
		public Move()
		{
			move = Internal.Board.Move.NullMove;
			pieceTypeData = 0;
		}
        ...
        {
			var data = Helpers.MoveHelper.CreateMoveFromName(moveName, board);
			move = data.move;
        ...
        /// </summary>
        public Move(Internal.Board.Move move, int movePieceType, int capturePieceType)
		{
			this.move = move;
