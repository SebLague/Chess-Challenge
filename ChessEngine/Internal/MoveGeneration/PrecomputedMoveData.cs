            ...
            for (int squareIndex = 0; squareIndex < 64; squareIndex++)
            {
                ...
                if (x > 0)
                {
                    if (y < 7)
                    {
                        ...
                        pawnAttackBitboards[squareIndex][Internal.Board.Board.WhiteIndex] |= 1ul << (squareIndex + 7);
                    }
                    if (y > 0)
                    {
                        pawnCapturesBlack.Add(squareIndex - 9);
                        pawnAttackBitboards[squareIndex][Internal.Board.Board.BlackIndex] |= 1ul << (squareIndex - 9);
                    }
                }
                if (x < 7)
                {
                    if (y < 7)
                    {
                        ...
                        pawnAttackBitboards[squareIndex][Internal.Board.Board.WhiteIndex] |= 1ul << (squareIndex + 9);
                    }
                    if (y > 0)
                    {
                        pawnCapturesBlack.Add(squareIndex - 7);
                        pawnAttackBitboards[squareIndex][Internal.Board.Board.BlackIndex] |= 1ul << (squareIndex - 7);
                    }
                }
