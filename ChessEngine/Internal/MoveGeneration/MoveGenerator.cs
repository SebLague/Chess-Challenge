...
namespace ChessEngine.Internal.MoveGeneration
{
    ...
    public class MoveGenerator
    {
        ...
        public System.Span<Internal.Board.Move> GenerateMoves(Internal.Board.Board board, bool includeQuietMoves = true)
        {
            System.Span<Internal.Board.Move> moves = new Internal.Board.Move[MaxMoves];
        ...
        public System.Span<Internal.Board.Move> GenerateMoves(Internal.Board.Board board, System.Span<Internal.Board.Move> moves, bool includeQuietMoves = true)
        {
            this.board = board;
        ...
        void GenerateKingMoves(System.Span<Internal.Board.Move> moves)
        {
            ...
            while (kingMoves != 0)
            {
                ...
                moves[currMoveIndex++] = new Internal.Board.Move(friendlyKingSquare, targetSquare);
            }
            ...
            if (!inCheck && generateQuietMoves)
            {
                ...
                if (board.currentGameState.HasKingsideCastleRight(board.IsWhiteToMove))
                {
                    ...
                    if ((castleMask & castleBlockers) == 0)
                    {
                        ...
                        moves[currMoveIndex++] = new Internal.Board.Move(friendlyKingSquare, targetSquare, Internal.Board.Move.CastleFlag);
                    }
                }
        ...
        void GenerateSlidingMoves(System.Span<Internal.Board.Move> moves)
        {
            ...
            while (othogonalSliders != 0)
            {
                ...
                while (moveSquares != 0)
                {
                    ...
                    moves[currMoveIndex++] = new Internal.Board.Move(startSquare, targetSquare);
                }
            }
        ...
        void GenerateKnightMoves(System.Span<Internal.Board.Move> moves)
        {
            ...
            while (knights != 0)
            {
                ...
                {
                    int targetSquare = BitBoardUtility.PopLSB(ref moveSquares);
                    moves[currMoveIndex++] = new Internal.Board.Move(knightSquare, targetSquare);
                }
            }
        }

        void GeneratePawnMoves(System.Span<Internal.Board.Move> moves)
        {
            ...
            if (generateQuietMoves)
            {
                ...
                while (doublePush != 0)
                {
                    ...
                    if (!IsPinned(startSquare) || alignMask[startSquare, friendlyKingSquare] == alignMask[targetSquare, friendlyKingSquare])
                    {
                        moves[currMoveIndex++] = new Internal.Board.Move(startSquare, targetSquare, Internal.Board.Move.PawnTwoUpFlag);
                    }
                }
            }
                ...
                if (BitBoardUtility.ContainsSquare(checkRayBitmask, capturedPawnSquare))
                {
                    ...
                    while (pawnsThatCanCaptureEp != 0)
                    {
                        ...
                        if (!IsPinned(startSquare) || alignMask[startSquare, friendlyKingSquare] == alignMask[targetSquare, friendlyKingSquare])
                        {
                            ...
                            {
                                moves[currMoveIndex++] = new Internal.Board.Move(startSquare, targetSquare, Internal.Board.Move.EnPassantCaptureFlag);
                            }
                        }
                    }
                }
        ...
        void GeneratePromotions(int startSquare, int targetSquare, Span<Internal.Board.Move> moves)
        {
            moves[currMoveIndex++] = new Internal.Board.Move(startSquare, targetSquare, Internal.Board.Move.PromoteToQueenFlag);
            ...
            if (generateQuietMoves)
            {
                if (promotionsToGenerate == MoveGenerator.PromotionMode.All)
                {
                    ...
                    moves[currMoveIndex++] = new Internal.Board.Move(startSquare, targetSquare, Internal.Board.Move.PromoteToBishopFlag);
                }
        ...
        void CalculateAttackData()
        {
            ...
            // Pawn attacks
            Internal.Board.PieceList opponentPawns = board.pawns[enemyIndex];
