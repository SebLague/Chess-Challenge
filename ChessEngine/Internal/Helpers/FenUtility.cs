...
namespace ChessEngine.Internal.Helpers
{
    ...
    public static class FenUtility
    {
        ...
        /// </summary>
        public static string CurrentFen(Internal.Board.Board board, bool alwaysIncludeEPSquare = true)
        {
            string fen = "";
        ...
        static bool EnPassantCanBeCaptured(int epFileIndex, int epRankIndex, Internal.Board.Board board)
        {
            ...
            bool CanCapture(Coord from)
            {
                ...
                {
                    Board.Move move = new Board.Move(from.SquareIndex, epCaptureSquare, Board.Move.EnPassantCaptureFlag);
                    board.MakeMove(move);
                    board.MakeNullMove();
